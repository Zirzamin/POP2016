...
\usepackage[utf8]{inputenc} %For � � � and other danish symbols
...
\newcommand{\hmwkTitle}{Ugeseddel\ \#6} % Assignment title
\newcommand{\hmwkDueDate}{Wednesday,\ October\ 26,\ 2016} % Due date
\newcommand{\hmwkClass}{Programmering og probleml��sning 5100-B1-2E16} % Course/class
